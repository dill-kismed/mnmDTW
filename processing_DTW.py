...
path_csv = r"H:\Doktorarbeit\Erstautor-Veröffentlichungen\23_05 POSTER Conference mnmDTW\Poster Prague\processed_videos\mediapipe_output.csv"
...
for e in range(3):
    for t in range(4):
        ...
        f.savefig(r"H:\Doktorarbeit\Poster Prague\figures" + "\\test_exercise" + str(e) + "_sample" + str(t) + ".png")
